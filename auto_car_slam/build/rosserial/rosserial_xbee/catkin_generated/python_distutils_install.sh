...
cd "/home/zhili/hector_slam_tutorial/auto_car_slam/src/rosserial/rosserial_xbee"
...
/usr/bin/env \
    ...
    build --build-base "/home/zhili/hector_slam_tutorial/auto_car_slam/build/rosserial/rosserial_xbee" \
    install \
    $DESTDIR_ARG \
