...
cd "/home/zhili/hector_slam_tutorial/auto_car_slam/src/rosserial/rosserial_python"
...
/usr/bin/env \
    ...
    build --build-base "/home/zhili/hector_slam_tutorial/auto_car_slam/build/rosserial/rosserial_python" \
    install \
    $DESTDIR_ARG \
